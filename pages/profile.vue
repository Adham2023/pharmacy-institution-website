    ...
    <div bg="#0037A0" rounded-2xl p-1px>
      ...
      <div px-2em py-1em>
        <ul text-sm text-white>
          <li>
            <NuxtLink active-class="text-green-400" to="/profile/personal-info" flex="~ gap-2 items-center" b-b="#0075FF" hover:bg="#0045C9" b-b-1 py-2>
              <div i-carbon-user /> Shaxsiy ma'lumotlar
            </NuxtLink>
          </li>
          <li>
            <NuxtLink active-class="text-green-400" to="/profile/contacts" flex="~ gap-2 items-center" b-b="#0075FF" hover:bg="#0045C9" b-b-1 py-2>
              <div i-carbon-phone /> Bog'lanish
            </NuxtLink>
          </li>
          <li>
            <NuxtLink active-class="text-green-400" to="/profile/change-profile-picture" flex="~ gap-2 items-center" b-b="#0075FF" hover:bg="#0045C9" b-b-1 py-2>
              <div i-carbon-image /> Rasmni o'zgartirish
            </NuxtLink>
          </li>
          <li>
            <NuxtLink active-class="text-green-400" to="/profile/password-setup" flex="~ gap-2 items-center" b-b="#0075FF" hover:bg="#0045C9" b-b-1 py-2>
              <div i-carbon-password /> Parolni o'zgartirish
            </NuxtLink>
          </li>
          <li>
            <NuxtLink active-class="text-green-400" to="/profile/documents" flex="~ gap-2 items-center" b-b="#0075FF" hover:bg="#0045C9" b-b-1 py-2>
