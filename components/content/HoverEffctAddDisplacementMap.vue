...
<template>
  <div class="p rounded-md bg-black p-2" flex justify-center>
    <div id="card-noise-disp" overflow-hidden class="aspect-[2/3] w-full border-[0.25rem] b-gray-600 md:w-290px">
...
<style>
 ...
 #card-noise-disp:hover > img {
  animation: pulse 800ms ease-in-out;
 }

 #card-noise-disp > img {
  filter: url(#noisedisplacement);
 }
</style>
